...
const SuccessModal: FC<SuccessModalProps> = ({ message, onClose }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center z-[9999] backdrop-blur-sm">
      <div className="relative bg-white border-l-4 border-green-600 rounded-2xl shadow-2xl p-6 max-w-sm w-full">
        {/* X Icon */}
        <button
          className="absolute top-3 right-3 text-gray-600 hover:text-green-600 transition"
          onClick={onClose}
        >
