      ...
      <div className="relative bg-white border-l-4 border-blue-500 rounded-2xl shadow-2xl p-6 max-w-sm w-full">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            onClick={onConfirm.bind(null, "Blocked")}
          >
            Block
          </button>
          <button
            className="w-full px-4 py-2 rounded-lg bg-yellow-400 text-white hover:bg-yellow-500 transition"
            onClick={onConfirm.bind(null, "Cancelled")}
          >
            Cancel Visit
          </button>
        </div>
